...
certificateRejected CertificateRejectAbsent =
    throwCore $ Error_Protocol ("certificate is missing", True, CertificateRequired, Nothing)
...
badCertificate msg = throwCore $ Error_Protocol (msg, True, BadCertificate, Nothing)
